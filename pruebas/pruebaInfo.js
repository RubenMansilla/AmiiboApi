/*//Referencia al boton de mostrar información
let btnInfo = document.getElementById('btnInfo');

//Agrega una función al botób de la información
btnInfo.addEventListener('click', mostrarInformacion);

function mostrarInformacion(){
    let ventanaInfo = document.createElement('div');
    ventanaInfo.className.add('ventanaInfo');
